...
describe('PokemonCard API', () => {
  ...
  describe('GET /pokemon-cards', () => {
    it('should fetch all PokemonCards', async () => {
      ...
      const mockPokemonCards = [{id: 1, name: 'Flamiaou', pokedexId: 725, type: { id: 1, name: 'Fire' }, typeId: 2, lifePoints: 70, size: 0.7, weight: 4, imageUrl: 'https://www.pokepedia.fr/images/thumb/6/6c/Flamiaou-USUL.png/800px-Flamiaou-USUL.png' }];
